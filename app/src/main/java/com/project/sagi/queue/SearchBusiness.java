...
public class SearchBusiness extends AppCompatActivity
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data)
    {
        if (getFragmentManager().getBackStackEntryCount() > 1) {
            Fragment f = getFragmentManager().findFragmentById(R.id.SignUpBusiness);
            if (f instanceof SignUpBusiness) {
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.search_business, menu);
        return true;
    }
